...
public class BlendLayerEffect {
    ...
    private Texture baseColorMap, normalMap, metallicRoughnessAoMap, emissiveMap;  //remove these and instead loop through all params of the first in the list of Materials for copy/pasting to newly registered mats  
    ...
    public BlendLayerEffect(String name, int layerIndex, ArrayList<Material> materials) {
        setName(name);
