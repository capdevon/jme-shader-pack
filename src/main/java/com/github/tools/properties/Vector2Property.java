 ...
 * @author capdevon
 */
public class Vector2Property extends JmeProperty<Vector2f> {
    
    private TextField textField;
    private Vector2f vector;
    
    public Vector2Property(Object bean, PropertyDescriptor pd) {
        super(bean, pd);
        vector = getValue();
    }
    ...
    protected String getAsText() {
        ...
        return String.format(Locale.US, "[%.2f, %.2f]", vector.x, vector.y);
    }
